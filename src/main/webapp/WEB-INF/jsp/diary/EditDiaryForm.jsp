    ...
    <stripes:form beanclass="org.mybatis.jpetstore.web.actions.DiaryActionBean"
        ...
        <table>
            <tr>
                ...
                <stripes:param name="diary.imgurl" value="${actionBean.diary.imgurl}" />
            </tr>
            <tr>
            ...
            <tr>
                <td><stripes:text name="diary.title" value="${actionBean.diary.title}"/></td>
            </tr>
            <tr>
                <td><stripes:text name="diary.content" value="${actionBean.diary.content}"/></td>
            </tr>
            <tr>
